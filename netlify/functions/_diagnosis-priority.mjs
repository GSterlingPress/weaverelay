...
export function prioritizeDiagnosis(diagnosis={},snapshot={}){
  ...
  for(const finding of findings){
    const blocker=blockedByProvider(finding,outages),stale=evidenceIds(finding).some(id=>explicitStale(checks[id]));
