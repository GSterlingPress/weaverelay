...
# Public-record structural replay of EPA OIG Report 19-P-0157, Task Order 12.
# IMPORTANT: the public report does not publish all underlying subcontract cost bases,
# so this fixture does NOT back-solve or inject the government's $5,158.29 aggregate.
# It tests whether the unchanged engine can interpret the published 6% fee clause
# and catch an 8% billed fee on a neutral, non-answer-derived subcontract cost base.
...
with tempfile.TemporaryDirectory() as td:
    ...
    result={
      ...
      'public_ground_truth':{
        ...
        'government_sample_overbilling':930.09,
        'government_non_sample_overbilling':4228.20,
